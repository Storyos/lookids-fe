...
h.minus = h.sub = function (e) {
  ...
  if (
    ((f = g.d), (d = e.d), (u = v.precision), (l = v.rounding), !f[0] || !d[0])
  ) {
    if (d[0]) e.s = -e.s;
...
h.plus = h.add = function (e) {
  ...
  if (
    ((f = a.d), (c = e.d), (u = d.precision), (l = d.rounding), !f[0] || !c[0])
  )
...
h.precision = h.sd = function (e) {
  ...
  return (
    i.d ? ((n = Ze(i.d)), e && i.e + 1 > n && (n = i.e + 1)) : (n = NaN), n
  );
};
h.round = function () {
  var e = this,
